...
### Heading (H2)
**The Importance of Legal Alteration Approval**
...
Unauthorized alterations will be discovered during:
- Liquor licence transfers (when selling)
- Licence renewals
- Inspections by authorities
Resolving violations retroactively is complicated and expensive.
...
### Step 9: Post-Completion Inspection
...
### Heading (H2)
**How Long Does Section 53 Approval Take?**
...
### Costs
- Government application fee: R1,000 - R2,500
- Building plan costs (architect/draftsman): R5,000 - R20,000+ (depends on scope)
...
## Regularizing Unauthorized Alterations
...
1. **Disclosure:** Acknowledge alterations and when they occurred
2. **Assessment:** We assess if alterations can be approved retroactively
3. **Documentation:** Prepare as-built plans showing current layout
4. **Application:** Apply for consent to regularize existing alterations
5. **Compliance:** Demonstrate current compliance with all regulations
6. **Resolution:** Authority grants consent or requires modifications
...
While Section 53 is national legislation, implementation varies:
...
### Gauteng
- Focus on compliance with building regs
- Metro vs rural variations
- Johannesburg particularly strict

### KwaZulu-Natal
- Coastal area development focus
- Tourism venue alterations well-supported
- Strong building compliance requirements
...
### Heading (H2)
**Section 53 Alteration FAQs**

#### Do I need Section 53 for minor renovations?
...
#### Can I start renovations while waiting for approval?
No. Starting work before approval is illegal and can result in licence suspension and fines.

#### How much does Section 53 application cost?
...
#### How long is Section 53 approval valid?
Typically 12 months to complete approved alterations. Extensions may be granted with motivation.

#### What happens if I sell my business with unapproved alterations?
...
## Get Section 53 Consent for Your Alterations
