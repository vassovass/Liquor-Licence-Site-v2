...
export const primaryNav: NavItem[] = [
  ...
  },
  {
    ...
    href: "/areas-served",
    children: [
      { label: "Cape Town CBD & Surrounds", href: "/areas-served#cape-town-cbd-detail" },
      { label: "Atlantic Seaboard", href: "/areas-served#atlantic-seaboard-detail" },
      { label: "Northern Suburbs", href: "/areas-served#northern-suburbs-detail" },
      { label: "Southern Suburbs", href: "/areas-served#southern-suburbs-detail" },
      { label: "Winelands", href: "/areas-served#winelands-detail" },
      { label: "Coastal Areas", href: "/areas-served#coastal-areas-detail" },
